            ...
            <div class="sidebar-nav">
                <div class="nav-canvas">
                    ...
                    <ul class="nav nav-pills nav-stacked main-menu">
                        ...
                        <li><a class="ajax-link" href="user.php"><i class="glyphicon glyphicon-picture"></i><span> Panier</span></a>
                        </li>
    ...
    <div class="box col-md-12">
        <div class="box-inner">
            ...
            <div class="box-content row">
                    <h1 align="center"><iframe src='Carrefour.html' width="90%" height="900" scrolling="no" seamless></iframe></h1>
    ...
    <div class="box col-md-4">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-user"></i>Choisisser un magasin</h2>
            ...
            <div class="box-content">
                <div class="box-content">
                    <ul class="dashboard-list">
                        <li><a href="car.php">carrefour</a></li>
                        <li><a href="mag.php">Magasin générale</a></li>
                        <li><a href="yat.php">Yatoo</a></li>
                    </ul>
                </div>
            </div>
        </div>
